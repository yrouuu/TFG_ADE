...
def print_metric_plots(X,y):
    ...
    plt.plot(test_sizes, train_accuracy, label='Train Accuracy',color='#a1c9f4')
    plt.plot(test_sizes, test_accuracy, label='Test Accuracy',color='#ffb482')
    ...
    plt.plot(test_sizes, train_precision, label='Train Precision', color='#a1c9f4')
    plt.plot(test_sizes, test_precision, label='Test Precision', color='#ffb482')
    plt.xlabel('Model Test Size (%)')
    ...
    plt.plot(test_sizes, train_recall, label='Train Recall',color='#a1c9f4')
    plt.plot(test_sizes, test_recall, label='Test Recall',color='#ffb482')
    plt.xlabel('Model Test Size (%)')
    ...
    plt.plot(test_sizes, train_f1, label='Train F1-Score',color='#a1c9f4')
    plt.plot(test_sizes, test_f1, label='Test F1-Score',color='#ffb482')
    plt.xlabel('Model Test Size (%)')
    plt.ylabel('F1-Score')
